<template>
  <section class="bg-white dark:bg-gray-900">
    <div class="text-sm font-light">Admin > 
          ...
          >
            ...
            <tbody>
              <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3">TK20223</td>
                <router-link :to="{ name: 'DetailPageMataKuliah' }">
                  <td class="px-4 py-3">Arsitektur Pembangunan</td>
                </router-link>
                <td class="px-4 py-3">2</td>
                <td class="px-4 py-3">4</td>
                <td class="px-4 py-3">Mark Zayed, M.Eng</td>
                <td class="px-4 py-3">Jumat, 7.15 - 8.55</td>
                <td class="px-4 py-3">Wajib</td>
              </tr>
            </tbody>
          </table>
        </div>
